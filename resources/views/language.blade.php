...
<body>
    ...
    <!-- Overlay for inactivity -->
    <div id="inactivityOverlay" class="overlay">
        <video autoplay muted loop>
            <source src="{{ asset('videos/te2.mp4') }}" type="video/mp4">
            Your browser does not support the video tag.
        </video>
    </div>

    <!-- JavaScript to handle inactivity and overlay -->
    <script>
        ...
        // Hide overlay and resume functionality on click
        document.getElementById('inactivityOverlay').addEventListener('click', function() {
