...
<body>
    ...
    <div class="card">
        ...
        <h1>{{ __('messages.registrations') }}</h1>
        <form action="{{ route('contractor.register') }}" method="POST">
            ...
            <div class="form-group">
                <label for="host" class="form-label">{{ __('messages.host') }}</label>
                <input type="text" id="host" name="host" class="form-control" required placeholder="{{ __('messages.host') }}">
            </div>
